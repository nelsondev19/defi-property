    ...
    <div className="space-y-16">
      ...
      <section className="container">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-4 text-sapphire-800">
        ...
        <div className="glass-section bg-gradient-to-br from-primary-600 to-primary-700 p-8 md:p-12 text-white text-center relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button className="btn bg-gradient-to-r from-primary-700 to-primary-800 hover:from-primary-800 hover:to-primary-900">
